/* Generated By:JJTree&JavaCC: Do not edit this line. JParserTokenManager.java */
package effect.jparser;

/** Token Manager. */
public class JParserTokenManager implements JParserConstants
{
...
/** Constructor. */
public JParserTokenManager(JavaCharStream stream){
...
/** Constructor. */
public JParserTokenManager(JavaCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
