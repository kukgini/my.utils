/* Generated By:JJTree&JavaCC: Do not edit this line. JParser.java */
package effect.jparser;

public class JParser/*@bgen(jjtree)*/implements JParserTreeConstants, JParserConstants {/*@bgen(jjtree)*/
  protected JJTJParserState jjtree = new JJTJParserState();public JParser()
    {
        super();
    }

    public JPCompilationUnit parse() throws ParseException
    {
 ...
 */
  final public JPCompilationUnit CompilationUnit() throws ParseException {
                                                        /*@bgen(jjtree) CompilationUnit */
  JPCompilationUnit jjtn000 = new JPCompilationUnit(JJTCOMPILATIONUNIT);
 ...
 /*@bgen(jjtree) PackageDeclaration */
  JPPackageDeclaration jjtn000 = new JPPackageDeclaration(JJTPACKAGEDECLARATION);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
 ...
 */
 ...
 /*@bgen(jjtree) FieldDeclaration */
    JPFieldDeclaration jjtn000 = new JPFieldDeclaration(JJTFIELDDECLARATION);
    boolean jjtc000 = true;
      ...
      while (true) {
        ...
        case PUBLIC:
          t = jj_consume_token(PUBLIC);
                       jjtn000.addAccessModifier(t.image);
          break;
        case PROTECTED:
 ...
 /*@bgen(jjtree) VariableDeclaratorId */
  JPVariableDeclaratorId jjtn000 = new JPVariableDeclaratorId(JJTVARIABLEDECLARATORID);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);Token t = null;
    try {
 ...
 */
 ...
 /*@bgen(jjtree) Type */
  JPType jjtn000 = new JPType(JJTTYPE);
  boolean jjtc000 = true;
 ...
 /*@bgen(jjtree) Name */
  JPName jjtn000 = new JPName(JJTNAME);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);Token t = null;
  String s = null;
    try {
 ...
 */
 ...
 /*@bgen(jjtree) Literal */
  JPLiteral jjtn000 = new JPLiteral(JJTLITERAL);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);Token t = null;
    try {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
...
// added by Andrea Gini
  ...
  public JParserTokenManager token_source;
  ...
  public JParser(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public JParser(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new JavaCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new JParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public JParser(java.io.Reader stream) {
  ...
  public JParser(JParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(JParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jjtree.reset();
